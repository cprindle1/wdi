...
5. **Open a new terminal tab** and navigate to your homework folder for tonight which includes:
...
8. Set up your `vampire_app.js` file to connect to your `monsters` database.
