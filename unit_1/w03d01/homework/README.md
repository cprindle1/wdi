...
- Make a folder inside your `homework` folder for w3d01 called `hogwarts`.
...
- [Open up your jQuery magic markdown file](https://github.com/ga-students/wdi-remote-hopper/wiki/jQuery-Cheatsheet )- for reference
...
Following what you did in previous years, add the following into an unordered list (with the attribute of `storage` and a value of  `trunk`):
  - list items of
   ...
   - In your `main.css` file, remove the bulltet points from the list items
...
- Update your class schedule to read 'Fall 2017'
...
- Whoops! You broke your trunk when you stood on it while singing karayoke. Get a new storage container for your stuff; replace the unodered list's property of `trunk` with a new property of `chest`
