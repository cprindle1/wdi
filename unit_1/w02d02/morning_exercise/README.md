...
## Getting Started
You already created the HTML for this mockup yesterday. You should have created it in your `w02d01/morning_exercise` folder

To copy your work into
`/w02d02/morning_exercise` folder

- In terminal:
 - navigate to your `/w02d02/morning_exercise` folder
 - from there type `cp ../../w02d01/morning_exercise/*.html .`
 - This command will copy all `html` files from yesterday's folder into today's morning exercise folder
 - Do the same command with `*.css` if you created a css file as well.

 Note: if you have created your files elsewhere, you will need to adjust the path.

## Directions:
- Using what you have learned about CSS from the videos and notes, style **and position** the HTML so it looks like the mockup.
