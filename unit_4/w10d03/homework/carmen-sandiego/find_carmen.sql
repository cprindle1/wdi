...
select language from country join countrylanguage on country.code = countrylanguage.countrycode where country.name = 'Holy See (Vatican City State)';
Italian
...
select * from city join country on country.code = city.countrycode where city.name like '%Serra%' and country.region = 'South America';
...
-- She's in __________Santa Monica California USA__________________!
